...
X = loadData("train-images.idx3-ubyte", trainingSize);
Y = loadLabels("train-labels.idx1-ubyte", trainingSize);
...
[theta1, J, exit_flag] = fmincg(@(Theta)(neuralCost(X, Y, Theta, archit, 5)), params, options);
